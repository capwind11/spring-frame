package com.allen.learn.core.mybatis;
...
public class MybatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/build-core-service/src/main/java");
        gc.setAuthor("daochuzhang");
        gc.setOpen(false);
        //允许覆盖生成
        ...
        //根据需要修改数据库连接
        dsc.setUrl("jdbc:mysql://9.134.127.118:3306/break_ip?useUnicode=true&useSSL=false&characterEncoding=utf8");
        // dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("112112");
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
//        pc.setModuleName(scanner("模块名"));
        pc.setParent("com.tencent.netplat.netbuild.core");
